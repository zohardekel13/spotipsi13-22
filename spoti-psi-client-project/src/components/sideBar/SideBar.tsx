...
const Sidebar = ({setPageContect}: { setPageContect: (pageName: string) => void }) => {
    /**
    ...
    return (
        <div className={classes.sidebarContainer}>
            <div className={classes.menuItem} onClick={()=>setPageContect("songs")}>
                <HomeIcon className={classes.menuIcon} />
                <p className={classes.menuText}>כל השירים</p>
            </div>

            <div className={classes.menuItem} onClick={()=>setPageContect("playlists")}>
                <LibraryMusicIcon className={classes.menuIcon} />
                <p className={classes.menuText}>פלייליסטים</p>
            </div>

            <div className={classes.menuItem} onClick={()=>setPageContect("favorites")}>
